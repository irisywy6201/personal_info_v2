...
if exist "C:\Program Files\Microsoft Office\Office14\OSPP.VBS" (goto pathProgramFiles) else goto pathProgramFiles86 
...
if not exist "C:\Program Files (x86)\Microsoft Office\Office14\OSPP.VBS" goto pathNotFound
@Echo:
echo 設定 KMS 金鑰管理伺服器
cscript %officepath%OSPP.VBS /sethst:kms-v4.cc.ncu.edu.tw
@Echo:
