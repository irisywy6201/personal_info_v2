  ...
  {!! Form::open([
    ...
    <fieldset>
      <div class="form-group">
        <h2>{{ Lang::get('about.editPosition') }}</h2>
      </div>
      ...
      <div class="form-group @if($errors->has('positionName')) has-error @endif">
        ...
        {!! Form::text('positionName', Input::old('positionName', $positionName), ['class' => 'form-control']) !!}
      ...
      <div class="form-group @if($errors->has('EnglishPositionName')) has-error @endif">
        ...
        {!! Form::text('EnglishPositionName', Input::old('EnglishPositionName', $EnglishPositionName), ['class' => 'form-control']) !!}
        <label class="control-label has-error">
      ...
      <div class="form-group @if($errors->has('positionDetail')) has-error @endif">
        ...
        {!! Form::textarea('positionDetail', Input::old('positionDetail', $positionDetail), ['class' => 'form-control']) !!}
        <label class="control-label has-error">
      ...
      <div class="form-group @if($errors->has('EnglishPositionDetail')) has-error @endif">
        ...
        {!! Form::textarea('EnglishPositionDetail', Input::old('EnglishPositionDetail', $EnglishPositionDetail), ['class' => 'form-control']) !!}
        <label class="control-label has-error">
